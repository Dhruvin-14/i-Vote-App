...
//    );
  ...
  _checkForNameInDatabase() async {
    DatabaseReference checkForUserName = FirebaseDatabase.instance
        .reference()
        .child("AllUsers")
        .child(enteredCode)
        .child("Members")
    ...
    if (snapshot.value == null) {
      ...
      if (selected == "VOTER") {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => VoterNdNominieeProfile(
                      code: enteredCode,
                      name: userName,
                      userID: userID,
                    )));
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => NominieeProfile(
                      code: enteredCode,
                      name: userName,
                      userId: userID,
                    )));
  ...
  void checkForTheCodeInDatabase() {
    ...
    codeExists(FirebaseDatabase.instance
        .reference()
        .child("AllUsers")
        .child(enteredCode));
  }
