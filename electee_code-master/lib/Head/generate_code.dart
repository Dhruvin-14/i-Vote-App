...
//    );
  ...
  checkForTheCodeIfExists() async {
    DatabaseReference checkCode =
        FirebaseDatabase.instance.reference().child("AllUsers").child(code);
  ...
  void registerDetails() {
    DatabaseReference _databaseReference =
        FirebaseDatabase.instance.reference(); // Insert Code and Head
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: TextButton(
                                ...
                                child:
                                    Text("Continue", style: kButtonTextStyle),
