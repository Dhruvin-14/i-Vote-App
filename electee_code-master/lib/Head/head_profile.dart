...
class _HeadProfileState extends State<HeadProfile> {
  ...
  DatabaseReference updateWinnerSetting =
    ...
    Alert(
        ...
        buttons: [
          ...
          DialogButton(
            ...
            onPressed: () {
              DatabaseReference electionStatus = FirebaseDatabase.instance
                  .reference()
                  .child("AllUsers")
                  .child(code);
  ...
  void initState() {
    ...
    // get the head Name
    DatabaseReference getHeadName = FirebaseDatabase.instance
        .reference()
        .child("AllUsers")
        .child(code)
        .child("Head");
                      ...
                      children: <Widget>[
                        ColorFiltered(
                          ...
                          colorFilter: ColorFilter.mode(
                              Colors.blueGrey[400], BlendMode.color),
                        ),
                        Align(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  if (totalRemoved != 0) {
                                    ...
                                    Toast.show(
                                        "You haven't Removed anyone", context,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            padding: EdgeInsets.symmetric(
                                vertical: 10.0, horizontal: 20.0),
                            child: Text(electionStatusTextOne,
                                textAlign: TextAlign.right,
                                style: kStatusTextOne),
                          ),
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 20.0),
                            child: Text(electionStatusTextTwo,
                                textAlign: TextAlign.right,
                                ...
                                onPressed: () {
                                  setState(() {
                                    if (localStatus == "false") {
                                      showDialogueTwoBtns(
                                          "Are you sure..?",
                                          "Wanna start the Election...?",
                                          "true"); // the third text is the value to be updated when the button is pressed
                                    } else if (localStatus == "true") {
                                      showDialogueTwoBtns(
                                          "Are you sure..?",
                                          "Wanna stop the Election...?",
                                          "done"); // the third text is the value to be updated when the button is pressed
                                    } else if (localStatus == "done") {
                                      showDialogueSingleBtns("Hey $headName",
                                          "You can now see the Winner in the Winner Section at the Bottom");
                                    }
                                  });
                                },
                                child: Text(
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    if (localStatus == "false") {
                                      showDialogueSingleBtns("Hey $headName",
                                          "You can start the Election when all the Members have joined..!");
                                    } else if (localStatus == "true") {
                                      showDialogueSingleBtns("Hey $headName",
                                          "Stop the Election when all the members have Voted");
                                    } else if (localStatus == "done") {
                              ...
                              children: <Widget>[
                                ...
                                shape: MaterialStateProperty.all(RoundedRectangleBorder(
                                  ...
                                  onPressed: () {
                                    if (localStatus == "false") {
                                      showDialogueSingleBtns("Hey $headName",
                                          "Election has not yet started, wait for it to get Over!");
                                    } else if (localStatus == "true") {
                                      showDialogueSingleBtns("Hey $headName",
